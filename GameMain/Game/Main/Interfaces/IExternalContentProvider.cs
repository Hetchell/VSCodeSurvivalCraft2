...
namespace Game
{
	...
	public interface IExternalContentProvider : IDisposable
	{
		...
		// (GetPoint) Token: 0x0600133E RID: 4926
		string DisplayName { get; }

		// Token: 0x170002C6 RID: 710
		// (GetPoint) Token: 0x0600133F RID: 4927
		bool SupportsLinks { get; }

		// Token: 0x170002C7 RID: 711
		// (GetPoint) Token: 0x06001340 RID: 4928
		bool SupportsListing { get; }

		// Token: 0x170002C8 RID: 712
		// (GetPoint) Token: 0x06001341 RID: 4929
		bool RequiresLogin { get; }

		// Token: 0x170002C9 RID: 713
		// (GetPoint) Token: 0x06001342 RID: 4930
		bool IsLoggedIn { get; }

		// Token: 0x170002CA RID: 714
		// (GetPoint) Token: 0x06001343 RID: 4931

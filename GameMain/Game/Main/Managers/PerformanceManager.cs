...
namespace Game
{
	...
	public static class PerformanceManager
	{
		...
		// (GetPoint) Token: 0x06001417 RID: 5143 RVA: 0x0009B928 File Offset: 0x00099B28
		...
		// (GetPoint) Token: 0x06001418 RID: 5144 RVA: 0x0009B92F File Offset: 0x00099B2F
		...
		// (GetPoint) Token: 0x06001419 RID: 5145 RVA: 0x0009B93B File Offset: 0x00099B3B
		...
		// (GetPoint) Token: 0x0600141A RID: 5146 RVA: 0x0009B947 File Offset: 0x00099B47
		...
		// (GetPoint) Token: 0x0600141B RID: 5147 RVA: 0x0009B94E File Offset: 0x00099B4E
		...
		static PerformanceManager()
		{
			...
			}, delegate
			{
				if (GameManager.Project != null)
				{
					...
					{
						//Console.Beep();
						float lastFrameTime = ProgramGame.LastFrameTime;
						float lastCpuFrameTime = ProgramGame.LastCpuFrameTime;
		...
		{
			PerformanceManager.m_averageFrameTime.AddSample(ProgramGame.LastFrameTime);
			PerformanceManager.m_averageCpuFrameTime.AddSample(ProgramGame.LastCpuFrameTime);
		...
		public static void Draw()
		{
			...
			if (SettingsManager.DisplayFpsRibbon)
			{
				...
				{
					CpuTime = ProgramGame.LastCpuFrameTime,
					TotalTime = ProgramGame.LastFrameTime
				};

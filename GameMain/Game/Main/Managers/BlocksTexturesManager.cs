...
namespace Game
{
	...
	public static class BlocksTexturesManager
	{
		...
		// (GetPoint) Token: 0x06001119 RID: 4377 RVA: 0x00085C4B File Offset: 0x00083E4B
		...
		// (GetPoint) Token: 0x0600111B RID: 4379 RVA: 0x00085C5A File Offset: 0x00083E5A
		...
		// (GetPoint) Token: 0x0600111C RID: 4380 RVA: 0x00085C66 File Offset: 0x00083E66

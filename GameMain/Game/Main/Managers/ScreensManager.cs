...
namespace Game
{
	...
	public static class ScreensManager
	{
		...
		// (GetPoint) Token: 0x0600062F RID: 1583 RVA: 0x000252A9 File Offset: 0x000234A9
		// (set) Token: 0x06000630 RID: 1584 RVA: 0x000252B0 File Offset: 0x000234B0
		public static ContainerWidget RootWidget { get; set; }

		// Token: 0x17000014 RID: 20
		// (GetPoint) Token: 0x06000631 RID: 1585 RVA: 0x000252B8 File Offset: 0x000234B8
		...
		// (GetPoint) Token: 0x06000632 RID: 1586 RVA: 0x000252C2 File Offset: 0x000234C2
		// (set) Token: 0x06000633 RID: 1587 RVA: 0x000252C9 File Offset: 0x000234C9
		public static Screen CurrentScreen { get; set; }

		// Token: 0x17000016 RID: 22
		// (GetPoint) Token: 0x06000634 RID: 1588 RVA: 0x000252D1 File Offset: 0x000234D1

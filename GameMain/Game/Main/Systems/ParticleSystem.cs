...
namespace Game
{
	...
	public class ParticleSystem<T> : ParticleSystemBase where T : Particle, new()
	{
		...
		// (GetPoint) Token: 0x06001409 RID: 5129 RVA: 0x0009B3D9 File Offset: 0x000995D9
		public T[] Particles
		{
			get
			{
		...
		// (GetPoint) Token: 0x0600140A RID: 5130 RVA: 0x0009B3E1 File Offset: 0x000995E1
		...
		// (GetPoint) Token: 0x0600140C RID: 5132 RVA: 0x0009B409 File Offset: 0x00099609

...
namespace Game
{
	...
	public class IntroCamera : BasePerspectiveCamera
	{
		...
		// (GetPoint) Token: 0x0600135E RID: 4958 RVA: 0x00096FBC File Offset: 0x000951BC
		...
		// (GetPoint) Token: 0x0600135F RID: 4959 RVA: 0x00096FBF File Offset: 0x000951BF
		...
		// (GetPoint) Token: 0x06001360 RID: 4960 RVA: 0x00096FC2 File Offset: 0x000951C2
		// (set) Token: 0x06001361 RID: 4961 RVA: 0x00096FCA File Offset: 0x000951CA
		public Vector3 CameraPosition { get; set; }

		// Token: 0x170002D2 RID: 722
		// (GetPoint) Token: 0x06001362 RID: 4962 RVA: 0x00096FD3 File Offset: 0x000951D3
		// (set) Token: 0x06001363 RID: 4963 RVA: 0x00096FDB File Offset: 0x000951DB
		public Vector3 TargetPosition { get; set; }

		// Token: 0x170002D3 RID: 723
		// (GetPoint) Token: 0x06001364 RID: 4964 RVA: 0x00096FE4 File Offset: 0x000951E4
		// (set) Token: 0x06001365 RID: 4965 RVA: 0x00096FEC File Offset: 0x000951EC
		public Vector3 TargetCameraPosition { get; set; }

		// Token: 0x170002D4 RID: 724
		// (GetPoint) Token: 0x06001366 RID: 4966 RVA: 0x00096FF5 File Offset: 0x000951F5

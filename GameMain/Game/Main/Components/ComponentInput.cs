...
namespace Game
{
	...
	public class ComponentInput : Component, IUpdateable
	{
		...
		public static ModificationsHolder ModHolder
		{
			get; set;
		}
		// Token: 0x17000192 RID: 402
		// (GetPoint) Token: 0x06000DC3 RID: 3523 RVA: 0x00069BE9 File Offset: 0x00067DE9
		...
		// (GetPoint) Token: 0x06000DC4 RID: 3524 RVA: 0x00069BF1 File Offset: 0x00067DF1
		// (set) Token: 0x06000DC5 RID: 3525 RVA: 0x00069BF9 File Offset: 0x00067DF9
		public bool IsControlledByTouch { get; set; } = true;

		// Token: 0x17000194 RID: 404
		// (GetPoint) Token: 0x06000DC6 RID: 3526 RVA: 0x00069C02 File Offset: 0x00067E02
        ...
        public override void Load(ValuesDictionary valuesDictionary, IdToEntityMap idToEntityMap)
		{
			...
			ModHolder = new(this.m_componentPlayer, this.m_componentGui, this.m_subsystemTime);
		}
		...
		public void UpdateInputFromMouseAndKeyboard(WidgetInput input)
		{
			...
			else
			{
				...
				Boolean noclipPrevState = ComponentBody.NoclipState;
				int speedPrev = speed;
		...
		{
			ModHolder.KeyboardActions(input);
        }
		...
		private void UpdateDebug(bool noclipPreviousState, int speedPreviously)
		{
			...
			if(noclipPreviousState != ComponentBody.NoclipState)
				Debug.WriteLine("Noclip is: " + (ComponentBody.NoclipState ? "Enabled" : "Not Enabled."));
        }
		...
		private void UpdatePlayerScreen(bool noclipPrevState, int speedPrev)
		{
            ...
            if (noclipPrevState != ComponentBody.NoclipState)
                guiMessage.DisplaySmallMessage("Noclip is: " + (ComponentBody.NoclipState ? "Enabled" : "Not Enabled."), Color.White, true, false);
        }

...
namespace Game
{
	...
	public class ComponentFlu : Component, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000CEB RID: 3307 RVA: 0x00061FAF File Offset: 0x000601AF
		public bool HasFlu
		{
			get
			{
		...
		// (GetPoint) Token: 0x06000CEC RID: 3308 RVA: 0x00061FBE File Offset: 0x000601BE
		...
		// (GetPoint) Token: 0x06000CED RID: 3309 RVA: 0x00061FCD File Offset: 0x000601CD

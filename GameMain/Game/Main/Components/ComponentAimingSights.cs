...
namespace Game
{
	...
	public class ComponentAimingSights : Component, IUpdateable, IDrawable
	{
		...
		// (GetPoint) Token: 0x06000B1E RID: 2846 RVA: 0x00052EFF File Offset: 0x000510FF
		// (set) Token: 0x06000B1F RID: 2847 RVA: 0x00052F07 File Offset: 0x00051107
		public bool IsSightsVisible { get; set; }

		// Token: 0x170000DB RID: 219
		// (GetPoint) Token: 0x06000B20 RID: 2848 RVA: 0x00052F10 File Offset: 0x00051110
		...
		// (GetPoint) Token: 0x06000B21 RID: 2849 RVA: 0x00052F14 File Offset: 0x00051114

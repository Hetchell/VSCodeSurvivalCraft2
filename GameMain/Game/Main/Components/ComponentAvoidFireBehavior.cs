...
namespace Game
{
	...
	public class ComponentAvoidFireBehavior : ComponentBehavior, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000B2D RID: 2861 RVA: 0x00053862 File Offset: 0x00051A62
		...
		// (GetPoint) Token: 0x06000B2E RID: 2862 RVA: 0x00053865 File Offset: 0x00051A65
		...
		// (GetPoint) Token: 0x06000B2F RID: 2863 RVA: 0x0005386D File Offset: 0x00051A6D

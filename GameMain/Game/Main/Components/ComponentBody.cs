...
namespace Game
{
	...
	public class ComponentBody : ComponentFrame, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000B75 RID: 2933 RVA: 0x000563A7 File Offset: 0x000545A7
  ...
  //                  return;
		...
		public void setVectorSpeed(Vector3 input, ComponentCreature creature, ComponentLocomotion locomotion, bool isAnimalInListAllowedToFly)
		{
			...
			{
				if (ModificationsHolder.FlyingLogicAnimal(creature) && isAnimalInListAllowedToFly)
				{
		...
		// (GetPoint) Token: 0x06000B91 RID: 2961 RVA: 0x000564BA File Offset: 0x000546BA
		...
		// (GetPoint) Token: 0x06000BA0 RID: 2976 RVA: 0x000565C5 File Offset: 0x000547C5
		...
		// (GetPoint) Token: 0x06000BA1 RID: 2977 RVA: 0x000565D2 File Offset: 0x000547D2
		...
		// (GetPoint) Token: 0x06000BA3 RID: 2979 RVA: 0x0005662C File Offset: 0x0005482C
		// (set) Token: 0x06000BA4 RID: 2980 RVA: 0x00056634 File Offset: 0x00054834
		public Vector3 ParentBodyPositionOffset { get; set; }

		// Token: 0x17000109 RID: 265
		// (GetPoint) Token: 0x06000BA5 RID: 2981 RVA: 0x0005663D File Offset: 0x0005483D
		...
		// (GetPoint) Token: 0x06000BA7 RID: 2983 RVA: 0x0005664E File Offset: 0x0005484E
		...
		//this thing only determines if the entity suffocates. 
		public bool MoveToFreeSpace()//N
		{
			Vector3 boxSize = this.BoxSize;
			Vector3 position = base.Position;
			for (int i = 0; i < ComponentBody.m_freeSpaceOffsets.Length; i++)
			{
				...
				if (!(Terrain.ToCell(vector2) != Terrain.ToCell(position)))
				{
					...
					if (!IsColliding(box, this.m_collisionBoxes))
					{
					...
					if (chunkAtCell != null)
					{
						...
						while (k <= point2.Y)
						{
							...
							if (num2 != 0)
							{
								...
								bool isPlayer = this.creatureIn is ComponentPlayer;
								if(isPlayer && NoclipState)
								{
									ComponentPlayer player = (ComponentPlayer)this.creatureIn;
									return;
								}
								if (block.IsCollidable)
								{
		...
		public static bool IsColliding(BoundingBox box, DynamicArray<ComponentBody.CollisionBox> collisionBoxes)
		{
        ...
        public static bool NoclipState { get; set; } = false;

...
namespace Game
{
	...
	public class ComponentSickness : Component, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000FA8 RID: 4008 RVA: 0x000779F1 File Offset: 0x00075BF1
		public bool IsSick
		{
			get
			{
		...
		// (GetPoint) Token: 0x06000FA9 RID: 4009 RVA: 0x00077A00 File Offset: 0x00075C00
		...
		// (GetPoint) Token: 0x06000FAA RID: 4010 RVA: 0x00077A0B File Offset: 0x00075C0B

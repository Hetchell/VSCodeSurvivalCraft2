...
namespace Game
{
	...
	public class ComponentCreatureModel : ComponentModel, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000C69 RID: 3177 RVA: 0x0005CD31 File Offset: 0x0005AF31
		...
		// (GetPoint) Token: 0x06000C6A RID: 3178 RVA: 0x0005CD5C File Offset: 0x0005AF5C

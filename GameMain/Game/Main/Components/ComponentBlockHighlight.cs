...
namespace Game
{
	...
	public class ComponentBlockHighlight : Component, IDrawable, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000B5B RID: 2907 RVA: 0x00054F80 File Offset: 0x00053180
		// (set) Token: 0x06000B5C RID: 2908 RVA: 0x00054F88 File Offset: 0x00053188
		public Point3? NearbyEditableCell { get; set; }

		// Token: 0x170000EA RID: 234
		// (GetPoint) Token: 0x06000B5D RID: 2909 RVA: 0x00054F91 File Offset: 0x00053191
		...
		// (GetPoint) Token: 0x06000B5E RID: 2910 RVA: 0x00054F98 File Offset: 0x00053198

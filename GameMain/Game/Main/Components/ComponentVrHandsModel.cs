...
namespace Game
{
	...
	public class ComponentVrHandsModel : Component, IDrawable, IUpdateable
	{
		...
		// (GetPoint) Token: 0x0600104D RID: 4173 RVA: 0x0007C91F File Offset: 0x0007AB1F

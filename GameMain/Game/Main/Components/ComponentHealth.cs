...
namespace Game
{
	...
	public class ComponentHealth : Component, IUpdateable
	{
		...
		public void Update(float dt)
		{
			...
			{
				Action<Vector3, IInventory> actionToPerform = ComponentInput.ModHolder.ProcessDeath(this.m_componentCreature, this);

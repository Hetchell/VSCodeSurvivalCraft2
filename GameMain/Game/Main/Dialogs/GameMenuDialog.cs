	...
	public class GameMenuDialog : Dialog
	{
		...
		public override void Update()
		{
			...
			if (this.Children.Find<ButtonWidget>("Quit", true).IsClicked)
			{
                ...
                Console.WriteLine("Score per shot for this instance! : " + ComponentInput.ModHolder.Score + " with " + ComponentInput.ModHolder.GetShots() + " shots.");
				//Console.WriteLine("Effectiveness: " + ComponentInput.ModHolder.Effective * 100 + "%");
				ProgramGame.FullScore.UpdateTotalScore(ComponentInput.ModHolder.GetShots(), ComponentInput.ModHolder.Score);
				ProgramGame.FullScore.UpdateWorldCount();

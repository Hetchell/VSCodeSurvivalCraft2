...
namespace Game
{
	...
	public class SubsystemFireworksBlockBehavior : SubsystemBlockBehavior, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000878 RID: 2168 RVA: 0x00039B55 File Offset: 0x00037D55
		...
		// (GetPoint) Token: 0x06000879 RID: 2169 RVA: 0x00039B5D File Offset: 0x00037D5D
		...
		public override void OnFiredAsProjectile(Projectile projectile)
		{
			...
			num = ModificationsHolder.fireworkDelayF(num);
		...
		{
            this.m_subsystemExplosions.AddExplosion((int)worldItem.Position.X, (int)worldItem.Position.Y, (int)worldItem.Position.Z,
                    ModificationsHolder.fireworks_yield, true, true);
            return true;
		}

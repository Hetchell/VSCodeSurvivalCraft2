...
namespace Game
{
	...
	public class SubsystemCreatureSpawn : Subsystem, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000751 RID: 1873 RVA: 0x0002E9F9 File Offset: 0x0002CBF9
		...
		// (GetPoint) Token: 0x06000752 RID: 1874 RVA: 0x0002EA06 File Offset: 0x0002CC06
		...
		public void Update(float dt)
		{
			if (this.m_subsystemGameInfo.WorldSettings.EnvironmentBehaviorMode == EnvironmentBehaviorMode.Living)
			{
				...
				if(ComponentInput.ModHolder != null)
				{
                    ComponentInput.ModHolder.ChangeTarget(this.m_subsystemTime, this.m_random);
                }
			}
		}

...
namespace Game
{
	...
	public class SubsystemGameInfo : Subsystem, IUpdateable
	{
        ...
        public override void Load(ValuesDictionary valuesDictionary)
		{
			...
			this.WorldSeed = ModificationsHolder.constantSeed ? ModificationsHolder.seed : valuesDictionary.GetValue<int>("WorldSeed");
		}

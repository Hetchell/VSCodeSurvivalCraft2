...
namespace Game
{
	...
	public class SubsystemExplosions : Subsystem, IUpdateable
	{
		...
		// (GetPoint) Token: 0x0600083E RID: 2110 RVA: 0x00036678 File Offset: 0x00034878
		...
		public void PostprocessExplosions(bool playExplosionSound)
		{
			...
			foreach (ComponentBody componentBody in this.m_subsystemBodies.Bodies)
			{
				...
				{
					ComponentCreature creature = componentBody.getCreature();
					if(creature != null && !creature.DisplayName.Contains("Player")) {

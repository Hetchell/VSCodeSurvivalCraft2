...
namespace Game
{
	...
	public class SubsystemTimeOfDay : Subsystem
	{
		...
		// (GetPoint) Token: 0x06000AB9 RID: 2745 RVA: 0x0004F980 File Offset: 0x0004DB80
		public float TimeOfDay
		{
			get
			{
				...
				if (this.m_subsystemGameInfo.WorldSettings.TimeOfDayMode == TimeOfDayMode.Changing && !ModificationsHolder.stopTime)
				{
				...
				if (this.m_subsystemGameInfo.WorldSettings.TimeOfDayMode == TimeOfDayMode.Night || ModificationsHolder.stopTime)
				{
		...
		// (GetPoint) Token: 0x06000ABA RID: 2746 RVA: 0x0004FA53 File Offset: 0x0004DC53
		public double Day
		{
			get
			{
		...
		// (GetPoint) Token: 0x06000ABB RID: 2747 RVA: 0x0004FA66 File Offset: 0x0004DC66

...
namespace Game
{
	...
	public class SubsystemCampfireBlockBehavior : SubsystemBlockBehavior, IUpdateable
	{
		...
		// (GetPoint) Token: 0x06000723 RID: 1827 RVA: 0x0002D8B2 File Offset: 0x0002BAB2
		...
		// (GetPoint) Token: 0x06000724 RID: 1828 RVA: 0x0002D8BF File Offset: 0x0002BABF
		...
		// (GetPoint) Token: 0x06000725 RID: 1829 RVA: 0x0002D8C2 File Offset: 0x0002BAC2

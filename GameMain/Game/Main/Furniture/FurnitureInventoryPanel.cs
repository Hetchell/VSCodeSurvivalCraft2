...
namespace Game
{
	...
	public class FurnitureInventoryPanel : CanvasWidget
	{
		...
		// (GetPoint) Token: 0x060012DA RID: 4826 RVA: 0x00093104 File Offset: 0x00091304
		// (set) Token: 0x060012DB RID: 4827 RVA: 0x0009310C File Offset: 0x0009130C
		public SubsystemTerrain SubsystemTerrain { get; set; }

		// Token: 0x170002BE RID: 702
		// (GetPoint) Token: 0x060012DC RID: 4828 RVA: 0x00093115 File Offset: 0x00091315
		...
		// (GetPoint) Token: 0x060012DE RID: 4830 RVA: 0x00093126 File Offset: 0x00091326

...
namespace Game
{
	...
	public class LoadingScreen : Screen
	{
		...
		public LoadingScreen()
		{
			...
			//read contents in pak. 
			ReadOnlyList<ContentInfo> listofcontents = ContentManager.List();
			foreach (ContentInfo localContentInfo2 in listofcontents)
			{
				ContentInfo localContentInfo = localContentInfo2;
				this.AddLoadAction(() => ContentManager.Get(localContentInfo.Name));
			}
			this.AddLoadAction(delegate
			{

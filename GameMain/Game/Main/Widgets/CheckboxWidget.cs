...
namespace Game
{
	...
	public class CheckboxWidget : CanvasWidget
	{
		...
		// (GetPoint) Token: 0x06001929 RID: 6441 RVA: 0x000C61C3 File Offset: 0x000C43C3
		...
		// (GetPoint) Token: 0x0600192A RID: 6442 RVA: 0x000C61D0 File Offset: 0x000C43D0
		...
		// (GetPoint) Token: 0x0600192B RID: 6443 RVA: 0x000C61DD File Offset: 0x000C43DD
		...
		// (GetPoint) Token: 0x0600192C RID: 6444 RVA: 0x000C61EA File Offset: 0x000C43EA
		// (set) Token: 0x0600192D RID: 6445 RVA: 0x000C61F2 File Offset: 0x000C43F2
		public bool IsChecked { get; set; }

		// Token: 0x1700040C RID: 1036
		// (GetPoint) Token: 0x0600192E RID: 6446 RVA: 0x000C61FB File Offset: 0x000C43FB
		// (set) Token: 0x0600192F RID: 6447 RVA: 0x000C6203 File Offset: 0x000C4403
		public bool IsAutoCheckingEnabled { get; set; }

		// Token: 0x1700040D RID: 1037
		// (GetPoint) Token: 0x06001930 RID: 6448 RVA: 0x000C620C File Offset: 0x000C440C
		...
		// (GetPoint) Token: 0x06001932 RID: 6450 RVA: 0x000C6227 File Offset: 0x000C4427
		...
		// (GetPoint) Token: 0x06001934 RID: 6452 RVA: 0x000C6242 File Offset: 0x000C4442
		...
		// (GetPoint) Token: 0x06001936 RID: 6454 RVA: 0x000C625D File Offset: 0x000C445D
		// (set) Token: 0x06001937 RID: 6455 RVA: 0x000C6265 File Offset: 0x000C4465
		public Color Color { get; set; }

		// Token: 0x17000411 RID: 1041
		// (GetPoint) Token: 0x06001938 RID: 6456 RVA: 0x000C626E File Offset: 0x000C446E

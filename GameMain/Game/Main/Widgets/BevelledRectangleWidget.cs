...
namespace Game
{
	...
	public class BevelledRectangleWidget : Widget
	{
		...
		// (GetPoint) Token: 0x060018D4 RID: 6356 RVA: 0x000C4BDE File Offset: 0x000C2DDE
		// (set) Token: 0x060018D5 RID: 6357 RVA: 0x000C4BE6 File Offset: 0x000C2DE6
		public float TextureScale { get; set; }

		// Token: 0x170003E9 RID: 1001
		// (GetPoint) Token: 0x060018D6 RID: 6358 RVA: 0x000C4BEF File Offset: 0x000C2DEF
		...
		// (GetPoint) Token: 0x060018D8 RID: 6360 RVA: 0x000C4C09 File Offset: 0x000C2E09
		// (set) Token: 0x060018D9 RID: 6361 RVA: 0x000C4C11 File Offset: 0x000C2E11
		public Color CenterColor { get; set; }

		// Token: 0x170003EB RID: 1003
		// (GetPoint) Token: 0x060018DA RID: 6362 RVA: 0x000C4C1A File Offset: 0x000C2E1A
		// (set) Token: 0x060018DB RID: 6363 RVA: 0x000C4C22 File Offset: 0x000C2E22
		public Color BevelColor { get; set; }

		// Token: 0x170003EC RID: 1004
		// (GetPoint) Token: 0x060018DC RID: 6364 RVA: 0x000C4C2B File Offset: 0x000C2E2B

...
namespace Game
{
	...
	public class BlockIconWidget : Widget
	{
		...
		// (GetPoint) Token: 0x060018F3 RID: 6387 RVA: 0x000C56D6 File Offset: 0x000C38D6
		...
		// (GetPoint) Token: 0x060018F5 RID: 6389 RVA: 0x000C56E7 File Offset: 0x000C38E7
		// (set) Token: 0x060018F6 RID: 6390 RVA: 0x000C56EF File Offset: 0x000C38EF
		public Vector2 Size { get; set; }

		// Token: 0x170003F7 RID: 1015
		// (GetPoint) Token: 0x060018F7 RID: 6391 RVA: 0x000C56F8 File Offset: 0x000C38F8
		// (set) Token: 0x060018F8 RID: 6392 RVA: 0x000C5700 File Offset: 0x000C3900
		public float Depth { get; set; }

		// Token: 0x170003F8 RID: 1016
		// (GetPoint) Token: 0x060018F9 RID: 6393 RVA: 0x000C5709 File Offset: 0x000C3909
		// (set) Token: 0x060018FA RID: 6394 RVA: 0x000C5711 File Offset: 0x000C3911
		public Color Color { get; set; }

		// Token: 0x170003F9 RID: 1017
		// (GetPoint) Token: 0x060018FB RID: 6395 RVA: 0x000C571A File Offset: 0x000C391A
		// (set) Token: 0x060018FC RID: 6396 RVA: 0x000C5722 File Offset: 0x000C3922
		public Matrix? CustomViewMatrix { get; set; }

		// Token: 0x170003FA RID: 1018
		// (GetPoint) Token: 0x060018FD RID: 6397 RVA: 0x000C572B File Offset: 0x000C392B
		...
		// (GetPoint) Token: 0x060018FF RID: 6399 RVA: 0x000C579C File Offset: 0x000C399C
		...
		// (GetPoint) Token: 0x06001901 RID: 6401 RVA: 0x000C57BD File Offset: 0x000C39BD
		...
		// (GetPoint) Token: 0x06001903 RID: 6403 RVA: 0x000C57DE File Offset: 0x000C39DE
		...
		// (GetPoint) Token: 0x06001905 RID: 6405 RVA: 0x000C57FF File Offset: 0x000C39FF

...
namespace Game
{
    public class SubsystemCommandBlockBehavior : SubsystemEditableItemBehavior<CommandData>
    {
        ...
        public override bool OnEditBlock(int x, int y, int z, int value, ComponentPlayer componentPlayer)
        {
            ...
            DialogsManager.ShowDialog(componentPlayer.ViewWidget.GameWidget, new TextBoxDialog("enter one-line command", commandBlockData.Command, 300, delegate (string result)
            {
        ...
        public override bool OnEditInventoryItem(IInventory inventory, int slotIndex, ComponentPlayer componentPlayer)
        {
            ...
            DialogsManager.ShowDialog(componentPlayer.ViewWidget.GameWidget, new TextBoxDialog("enter a one-line command", commandBlockData.Command, 300, delegate (string result)
            {
                commandBlockData.Command = result;

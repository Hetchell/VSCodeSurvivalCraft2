...
namespace Game
{
    public class SubsystemCommandEngine : Subsystem
    {
        ...
        public override void Save(TemplatesDatabase.ValuesDictionary valuesDictionary)
        {
        ...
        bool RunCommand(CommandStream stream)
        {
            ...
            catch (Exception e)
            {
                if (!(e is SilentException))
                {
                    ...
                    {
                        p.ComponentGui.DisplaySmallMessage(str, Color.White, false, false);
                    }
                }
                return false;
            }
        ...
        void InitCommands()
        {
            commands["msg"] = new CommandDefination
            {
                ...
                Operation = (obj) =>
                {
                    ...
                    {
                        a.ComponentGui.DisplaySmallMessage(msg, Color.White, b1, b2);
                    });
                }
            };

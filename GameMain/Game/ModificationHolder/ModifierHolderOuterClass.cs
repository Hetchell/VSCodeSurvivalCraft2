...
using Engine;
using mod = Survivalcraft.Game.ModifierHolder;

namespace ModificationHolder
{

    class ModifierHolderOuterClass
    {
        ...
        public ModifierHolderOuterClass(SubsystemTerrain terrainInput, TerrainChunkGeneratorProviderActive activeChunkProvider, float num, Random rand)
        {
